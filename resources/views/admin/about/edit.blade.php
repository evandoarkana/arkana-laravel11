...
<head>
    ...
    <style>
        ...
        * {
        ...
        @keyframes neonGlow {
            0% { text-shadow: 0 0 12px #bc9bf1, 0 0 24px #bc9bf1, 0 0 36px #bc9bf1, 0 0 48px #bc9bf1; }
            100% { text-shadow: 0 0 18px #4902ba, 0 0 36px #4902ba, 0 0 54px #4902ba, 0 0 72px #4902ba; }
        }
        ...
        .content {
            ...
            margin: 50px auto;
            padding: 40px;
            background-color: #4902ba;
            border-radius: 12px;
            box-shadow: 0 0 20px rgba( 188, 155, 241, 0.1);
